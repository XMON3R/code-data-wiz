...
//Python, JavaScript 
//https://www.npmjs.com/package/tree-sitter?activeTab=readme
//https://www.npmjs.com/package/tree-sitter-python

//RDF/XML
//https://www.npmjs.com/package/@comunica/actor-rdf-parse-rdfxml


/* 

Tree-Sitter:	SQL, Python, C#, Java, JavaScript, TypeScript, PHP	AST (JSON-like)	✅ Ano, AST lze sjednotit

json-schema-ref-parser:	JSON Schema	Normalizovaný JSON	✅ Přímé použití

rdf-parse:	RDF	RDF Quads (JSON)	✅ Možno převést do JSON-LD

antlr4:	SQL, Python, Java, JS, C# a další (pomocí gramatik)	AST	✅ Možnost sjednocení AST

Peg.js	Vlastní gramatiky	AST	✅ Možnost sjednocení AST

Chevrotain	Vlastní gramatiky	AST	✅ Možnost sjednocení AST
